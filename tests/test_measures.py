...
@pytest.mark.parametrize("shape", [(500, 101), (10, 100), (4, 6)])
def test_calc_distance_and_direction_any_shape(shape):
    """
...
@pytest.mark.parametrize(
    "direction_from_turbine,turbine_bearing,lookangle", [
        (270, 0, 90),
        (0, 0, 0),
        (90, 0, 90),
        (135, 0, 135),
...
def test_calc_lookangle_floats(direction_from_turbine, turbine_bearing, lookangle):
    """
...
@pytest.mark.parametrize(
    "direction_from_turbine_val,turbine_bearing,lookangle_val", [
        (45, 90, 45),
        (30, 120, 90),
        (90, 270, 180),
        (215, 30, 175),
