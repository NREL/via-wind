...
VERSION_FILE = os.path.join(REPO_DIR, "via_wind", "version.py")
DESCRIPTION = (
    "Perform visual impact assessment for wind turbines using a combination of "
    "3D simulation of turbines of varying dimensions and orientations, and GIS "
    "analysis."
)
...
setup(
    ...
    package_dir={"via_wind": "via_wind"},
    entry_points={
        "console_scripts": [
            "via=via_wind.cli.cli:main",
        ],
    },
    zip_safe=False,
    keywords="via-wind",
